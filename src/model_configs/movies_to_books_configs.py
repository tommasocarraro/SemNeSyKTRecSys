...
train_movies_to_books_config = ModelConfig(
    ...
    ltn_train_config=TrainConfigLtn(
        ...
        weight_decay=0.07,
        batch_size=512,
        checkpoint_save_path=Path("./target_models/checkpoint_ltn_movies_books.pth"),
        final_model_save_path=Path("./target_models/best_ltn_movies_books.pth"),
        p_forall=2,
    ),
    ltn_reg_train_config=TrainConfigLtnReg(
        ...
        weight_decay=0.07,
        batch_size=512,
        checkpoint_save_path=Path("./target_models/checkpoint_ltn_reg_movies_books.pth"),
        final_model_save_path=Path("./target_models/best_ltn_reg_movies_books.pth"),
        top_k_src=10,
        p_forall=2,
        p_sat_agg=2,
        neg_score=0.0,
