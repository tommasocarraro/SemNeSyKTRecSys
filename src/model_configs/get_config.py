...
from .movies_to_books_configs import train_movies_to_books_config, tune_movies_books_config
...
configs_dict = {
    ...
    "movies": {"books": (train_movies_to_books_config, tune_movies_books_config)},
    "music": {"movies": (train_music_to_movies_config, tune_music_to_movies_config)},
}


def get_config(
    src_dataset_name: Literal["books", "movies", "music"],
    tgt_dataset_name: Literal["books", "movies", "music"],
