...
if __name__ == "__main__":
    ...
    #                         n_cores=10)
    linking_stats("./data/processed/mappings/mapping-movies.json", errors=["not-title", "not-found-query",
                                                                      "exception", "not-in-correct-category",
                                                                      "long-title-exception"])
    linking_stats("./data/processed/mappings/mapping-music.json", errors=["not-title", "not-found-query",
                                                                     "exception", "not-in-correct-category",
                                                                     "long-title-exception"])
    linking_stats("./data/processed/mappings/mapping-books.json", errors=["not-title", "not-found-query",
                                                                     "exception", "not-in-correct-category",
                                                                     "long-title-exception"])
